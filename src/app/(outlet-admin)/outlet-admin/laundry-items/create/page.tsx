...
import useCreateLaundryItem from "@/features/super-admin/laundry-items/hooks/useCreateLaundryItem";

export default function OutletAdminCreateLaundryItemPage() {
  const { formik, isLoading } = useCreateLaundryItem("/outlet-admin/laundry-items");
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Add Laundry Item</h1>
      </div>
