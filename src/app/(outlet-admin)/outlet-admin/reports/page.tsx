...
const reportCards = [
  {
    title: "Sales Report",
    description:
      "View income reports for your outlet. Analyze revenue trends by day, month, or year with flexible date filters.",
  ...
  },
  {
    ...
    description:
      "Track worker and driver productivity in your outlet. See total tasks completed per employee.",
...
export default function OutletAdminReportsPage() {
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Gain insights into your outlet performance
        </p>
      </div>
