    ...
    <div className="min-h-screen bg-[#FAF6F1]">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#10b981] to-[#34d399] text-white flex items-center justify-center font-bold shadow-md text-sm">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        {activeTab === "pickup" && <ComingSoon label="Pickup Tasks" />}
        {activeTab === "history" && <ComingSoon label="Delivery History" />}
      </div>
    </div>
  );
}
